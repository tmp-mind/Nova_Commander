...
# Commandes spécifiques pour le contrôle du curseur et des touches
COMMANDS = {
    ...
    "touche un": "press_key_one",
    "touche deux": "press_key_two",
    "touche trois": "press_key_three",
    "touche quatre": "press_key_four",
    "touche cinq": "press_key_five",
    "touche six": "press_key_six",
    "touche sept": "press_key_seven",
    "touche huit": "press_key_eight",
    "touche neuf": "press_key_nine",
    "touche zéro": "press_key_zero",
    "ferme le module de jeu": "close_cursor_module"
}
...
# Fonction pour appuyer sur les touches 1 à 9 et 0
def press_key_one(command_text=None):
    keyboard.press_and_release('1')
    print("Touche 1 pressée.")

def press_key_two(command_text=None):
    keyboard.press_and_release('2')
    print("Touche 2 pressée.")

def press_key_three(command_text=None):
    keyboard.press_and_release('3')
    print("Touche 3 pressée.")

def press_key_four(command_text=None):
    keyboard.press_and_release('4')
    print("Touche 4 pressée.")

def press_key_five(command_text=None):
    keyboard.press_and_release('5')
    print("Touche 5 pressée.")

def press_key_six(command_text=None):
    keyboard.press_and_release('6')
    print("Touche 6 pressée.")

def press_key_seven(command_text=None):
    keyboard.press_and_release('7')
    print("Touche 7 pressée.")

def press_key_eight(command_text=None):
    keyboard.press_and_release('8')
    print("Touche 8 pressée.")

def press_key_nine(command_text=None):
    keyboard.press_and_release('9')
    print("Touche 9 pressée.")

def press_key_zero(command_text=None):
    keyboard.press_and_release('0')
    print("Touche 0 pressée.")
